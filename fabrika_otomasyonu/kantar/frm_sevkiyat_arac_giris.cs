...
namespace kantar
{
    public partial class frm_sevkiyat_arac_giris : Form
    {
        public frm_sevkiyat_arac_giris()
        {
            InitializeComponent();
        }
        ...
        private void frm_sevkiyat_arac_giris_Load(object sender, EventArgs e)
        {
            listelefirma();
            listelememur();
            listeleplaka();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                komut.Parameters.AddWithValue("@p1", 2); //1=stok işlemi 2=sevkiyat işlemi
                ...
                komut.Parameters.AddWithValue("@p11", "araç sevkiyat için fabrikaya giriş yapıldı");
