...
namespace kantar
{
    public partial class frm_stok_arac_cikis : Form
    {
        public frm_stok_arac_cikis()
        {
            InitializeComponent();
        }
        public void listele()
        {
            SqlDataAdapter da= new SqlDataAdapter("select ID,plaka,girisTarih,ilkTartim from tbl_tanitim where durum=1 and tur=1",baglanti.baglan());
        ...
        private void frm_stok_arac_cikis_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand komut = new SqlCommand("update tbl_tanitim set durum=@p1,ikinciTartim=@p2,netTartim=ilkTartim-@p2,cıkısTarih=@p3 where ID =@p4 and tur=1  ", baglanti.baglan());
                ...
                MessageBox.Show("Araç Çıkıs işlemi başarı ile tamamlandı", "bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            listele();
        }
    }
